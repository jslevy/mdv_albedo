#This is the rh_alb code, but breaks each dataset down by year first. 
#Importantly, it also corrects RH to boundary layer RH based on soil temperature
...
path_output <- paste("working_data/by_year/",sitename,"/", sep="")
